...
export const getOrder = async (req, res) => {
 ...
 export const createOrder = async (req, res) => {
    const { nombre, apellido, telefono, email, line1, line2, province, country } = req.body;
    const [result] = await pool.query('INSERT INTO `order` (nombre, apellido, telefono, email, line1, line2, province, country) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
    [
        nombre,
        apellido,
        telefono,
