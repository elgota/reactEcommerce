...
export const getUsers = async (req, res) => {
    const [result] = await pool.query("SELECT * FROM user ORDER BY registeredAt ASC"
    );
...
export const createUser = async (req, res) => {
    ...
    const [result] = await pool.query("INSERT INTO user (nombre, apellido, telefono, email, passwordHash) VALUES (?, ?, ?, ?, ?)", 
    [
        nombre,
        apellido,
        telefono,
