...
const Login = () => {
    ...
    function consultData () {
        if (inputTextEmail === localStorage.getItem('email') && inputTextPassword === localStorage.getItem('password')) {
        ...
        <div className={css.mainContainerLogin}>
            <div className={css.loginContainer}>
                ...
                <form className={css.formContainer}>
                    <input type="text" name='email' placeholder='Correo' onChange={handleInputChangeEmail} required />
                    <input type="password" name='password' placeholder='Contraseña' onChange={handleInputChangePassword} required />
