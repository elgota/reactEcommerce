...
const Products = () => {
  ...
  return (
    <>
...

            {
              MenuProducts.map((product, i) => (
                <div className={css.product} key={i}>
                  ...
                  <div className={css.btnDescPro} onClick={() => onBtnShowDesc(boxSHDescProd.current, product)}>Ver descripción</div>
                  </div>
      ...
      <div className={css.divSHDescProd} ref={boxSHDescProd} style={{display:'none'}}>
        <div className={css.barTopDivSH}><FontAwesomeIcon icon={faTimes} onClick={() => onBtnHideDesc(boxSHDescProd.current)} /></div>
        <div className={css.contentDivSH}>
          <div className={css.imgSHDescProd} style={{backgroundImage:`url(${imgBoxSHDescProd})`}}></div>
          <div>
            <p>Nombre producto: <span>{nameBoxSHDescProd}</span></p>
            <p>Detalles del producto: <span>{detailBoxSHDescProd}</span></p>
            <p>Tipo de producto: <span>{typeBoxSHDescProd}</span></p>
            <p>Precio producto: $<span>{priceBoxSHDescProd}</span></p>
            <div className={css.divContLink}>
              <Link to={`/ListaCarrito/${iDBoxSHDescProd}`} className={css.linkCarSHDescProd}><span>Añadir al carrito</span></Link>
            </div>
          </div>
        </div>
      </div>
