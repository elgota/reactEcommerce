...
INSERT INTO `user` (`firstName`,`middleName`,`lastName`,`mobile`,`email`,`passwordHash`,`admin`,`vendor`,`registeredAt`,`lastLogin`,`intro`,`profile`) VALUES ('Angelo','Michael','Huaraca','987654321','angelo.huaraca@gmail.com','password1',1,1,'2022-11-01 12:32:05','2022-11-09 20:27:06','Proveedor con 20 años de experiencia','Atención solo en Perú');
...
INSERT INTO `user` (`firstName`,`middleName`,`lastName`,`mobile`,`email`,`passwordHash`,`admin`,`vendor`,`registeredAt`,`lastLogin`,`intro`,`profile`) VALUES ('Josue','Enrique','Quispe','999888777','josue.quispe@gmail.com','password3',0,1,'2022-11-02 12:32:54','2022-11-03 10:22:55','Proveedor con 10 años de experiencia','Atención solo en Chile');
INSERT INTO `user` (`firstName`,`middleName`,`lastName`,`mobile`,`email`,`passwordHash`,`admin`,`vendor`,`registeredAt`,`lastLogin`,`intro`,`profile`) VALUES ('Jose','Luis','Figueroa','987456321','jose.figueroa@gmail.com','password4',0,0,'2022-11-05 07:23:44','2022-11-07 21:33:44',null, null);
INSERT INTO `user` (`firstName`,`middleName`,`lastName`,`mobile`,`email`,`passwordHash`,`admin`,`vendor`,`registeredAt`,`lastLogin`,`intro`,`profile`) VALUES ('Frank','Alberto','Rodriguez','963258741','frank.rodriguez@gmail.com','password5',0,0,'2022-11-03 12:44:19','2022-11-10 06:33:44', null, null);
